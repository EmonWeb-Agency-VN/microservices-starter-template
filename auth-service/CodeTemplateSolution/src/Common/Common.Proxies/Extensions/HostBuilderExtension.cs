...
namespace Common.Proxies.Extensions
{
    ...
    {
        public static ConfigureHostBuilder AddLoggingConfiguration(this ConfigureHostBuilder builder, CommonConfig config)
        {
#pragma warning disable ASP0011 // Suggest using builder.Logging over Host.ConfigureLogging or WebHost.ConfigureLogging
            builder.ConfigureLogging((context, logging) =>
            {
                ...
                if (LogManager.Configuration != null)
                {
                    ...
                    //LogManager.Configuration.Variables["seqUrl"] = config.Seq.Url;
                    //LogManager.Configuration.Variables["seqApiKey"] = config.Seq.ApiKey;
